...
- Android Studio 集成 IDE开发平台，[下载](<http://developer.android.com/intl/zh-cn/sdk/index.html>)
- Android 开发SDK，[下载](<https://developer.android.com/intl/zh-cn/sdk/index.html#Other>)
...
```
UVideoRecord mVideoRecorder = new UVideoRecord(); // 设置录制状态回调
...
//视频编码参数 
UVideoEncodeParam videoEncodeParam = new
...
```
mVideoRecorder.init(preview, cameraParam,microphoneParam,
...
```
 @Override public int onDrawFrame(int texId, int texWidth, int
