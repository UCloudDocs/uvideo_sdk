...
* 切换到指定摄像头 
*/ 
public void switchCamera(UCameraParam.CAMERA\_FACING\_ID facingId);
...
*/
public UCameraParam setCameraPreviewSizeLevel(UCameraParam.CAMERA_PREVIEW_SIZE_LEVEL
level);
...
*/ 
public UCameraParam
setCameraPreviewSizeRatio(UCameraParam.CAMERA_PREVIEW_SIZE_RATIO
ratio); 
```
...
*/ 
public UVideoEncodeParam setEncodingSizeLevel(UVideoEncodeParam.VIDEO_ENCODING_SIZE_LEVEL
level);
...
/** 
* 设置音频声道数 
* @param 声道数，目前只支持 1 (默认) 和 2，分别对应 UMicrophoneParam 声道设置的 AudioFormat.CHANNEL_IN_MONO 与AudioFormat.CHANNEL_IN_STEREO 
*/ 
...
* @param extra相关信息 
*/ 
void onStateChanged(UStreamingState state, Object
extra); 
...
* @param texHeight height of the drawing
surface in pixels. 
...
* 采集到一帧音频时触发 
* @param data PCM 数据 
* @param timestampNs音频帧时间戳，单位为 ns 
*/ 
...
*/ 
void onVideoInfoChanged(double fps, double
bitrate);
